...
public class API {
     ...
     * @return
     */
    public List<Object> parseInput(String input, Boolean isFile){
        ParserInterface p = new JSONParser();
        List<Object> objects = p.parse(input, isFile);
        return objects;
    }
     ...
     */
    public Plan generatePlanFromParsedObjects(List<Object> parsedObjects){
    ...
    public void executePlan(String input, Boolean isFile){
        List<Object> objects = parseInput(input, isFile);
