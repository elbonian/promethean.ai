...
public class API {
     ...
     * @param parsedObjects List of objects generated by parser
     */
    public Plan generatePlanFromParsedObjects(Map<String, Object> parsedObjects, String outputFilePath, int stopTime, boolean activateCLF) {
     ...
     * @return Generated plan
     */
    public Plan generatePlanFromJSON(String inputFile, Boolean isFile, String outputFilePath, int stopTime, boolean activateCLF){
