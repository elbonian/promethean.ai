...
public class API {
    private static String className = "API";

    public API(){

    }
    public static void throwPlannerError(String err_msg){
        PlannerError e = new PlannerError(err_msg);
        Logger.logError(e, className);
        throw e;
    }

    public static void throwParserError(String err_msg){
        ParserError e = new ParserError(err_msg);
        Logger.logError(e, className);
        throw e;
    }
    public static void throwOutputError(String err_msg){
        OutputError e = new OutputError(err_msg);
        Logger.logError(e, className);
        throw e;
    }

    public static void throwCLIError(String err_msg){
    ...
    public static Map<String, Object> parseInput(String inputFile, boolean isFile){
     ...
     */
    public static Plan generatePlanFromParsedObjects(Map<String, Object> parsedObjects, double stopTime, boolean activateCLF){
     ...
     * @param parsedObjects List of objects generated by parser
     */
    public static Plan generatePlanFromParsedObjects(Map<String, Object> parsedObjects, String outputFileDir, double stopTime, boolean activateCLF) {
     ...
     */
    public static Plan generatePlanFromJSON(String inputFile, Boolean isFile, double stopTime, boolean activateCLF){
     ...
     * @return Generated plan
     */
    public static Plan generatePlanFromJSON(String inputFile, Boolean isFile, String outputFileDir, double stopTime, boolean activateCLF){
     ...
     * @return
     */
    public static Plan generatePlanFromSystemState(SystemState currentState,
                                            GoalState goalState,
    ...
    public static List<SystemState> executeExistingPlan(Plan plan, Map<String, Object> parsedObjects, double stopTime, boolean activateCLF){
     ...
     */
    public static List<SystemState> executePlan(String input, Boolean isFile, String outputPlanPath, String outputStatesPath, double stopTime, boolean activateCLF){
     ...
     * Initialize the clock and handle perturbation or goal state responses
     */
    public static List<SystemState> executePlan(String input, Boolean isFile, double stopTime, boolean activateCLF){
        Map <String, Object> objects = parseInput(input, isFile);
